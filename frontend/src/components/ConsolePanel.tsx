...
export function ConsolePanel({ win }: { win: WindowInstance }) {
  ...
  return (
    <div className="flex h-full flex-col bg-recess/40 font-mono text-[12.5px] text-emerald-200/90">
      <div className="flex items-center justify-between border-b border-fg/10 px-3 py-1 text-[11px] text-fg/50">
