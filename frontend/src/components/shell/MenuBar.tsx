...
export function MenuBar({ projectName, conn }: MenuBarProps) {
  ...
  return (
    <header className="glass-strong fixed inset-x-0 top-0 z-[900] flex h-9 items-center gap-3 border-b border-fg/10 px-3 text-[13px] text-fg/85">
      {/* Brand */}
      <div className="flex items-center gap-2 font-semibold">
        <span className="grid h-5 w-5 shrink-0 place-items-center rounded bg-accent text-[11px] font-bold text-fg">
          N
        </span>
      ...
      <span className="max-w-[140px] truncate text-fg/65 sm:max-w-none">{projectName}</span>
      ...
      {/* View mode toggle */}
      <div className="flex items-center rounded-md border border-fg/10 bg-fg/5 p-0.5">
        <button
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          className="grid h-7 w-7 place-items-center rounded-md text-fg/60 hover:bg-fg/10 hover:text-fg"
        >
        ...
        {/* Clock */}
        <time className="tabular-nums text-fg/50">
        ...
        <div className="relative" ref={userMenuRef}>
          ...
          {userMenuOpen && (
            <div className="glass-strong absolute right-0 top-9 z-[1000] min-w-[160px] overflow-hidden rounded-lg border border-fg/15 shadow-glass-lg animate-fade-in">
